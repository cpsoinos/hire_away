...
(function() {
  $('.new-venue-button').click(function() {
    $('#new-venue-form').toggle('slow', function() {});
  });

  $('#new-venue-submit-button').click(function() {
    $('#new-venue-form').toggle('slow', function() {});
  });

  $('#add-position-button').click(function() {
    $('#add-position-menu').toggle('slow', function() {});
  });

  $('#add-position-submit-button').click(function() {
    $('#add-position-menu').toggle('slow', function() {});
  });

  $('#call-action-button').click(function() {
    $('#add-position-menu').toggle('slow', function() {});
  });

  $('#new-position-button').click(function() {
    $('#new-position-form').toggle('slow', function() {});
  });

  $('#position-action-button').click(function() {
    $('#new-position-form').toggle('slow', function() {});
  });

}).call(this);
(function() {
  $('#venue-action-button').click(function() {
    $('#new-venue-form-2').toggle('slow', function() {});
  });
...
$(document).on('ready page:load', function () {
  $("#country_id").change(function() {
    ...
    var canadan_state =
    [["Alberta", "AB"], ["British Columbia", "BC"], ["Manitoba", "MB"], ["New Brunswick", "NB"], ["Newfoundland and Labrador", "NL"], ["Northwest Territories", "NT"], ["Nova Scotia", "NS"], ["Nunavut", "NU"], ["Ontario", "ON"], ["Prince Edward Island", "PE"], ["Quebec", "QC"], ["Saskatchewan", "SK"], ["Yukon Territory", "YT"]]
    var uk_state =
    [["Aberdeen", "ABE"], ["Aberdeenshire", "ABD"], ["Alderney", "ALD"], ["Anglesey (Isle of)", "AGY"], ["Angus", "ANS"], ["Ards", "ARD"], ["Argyll and Bute", "AGB"], ["Ayrshire", "AYR"], ["Ballymena", "BLA"], ["Ballymoney", "BLY"], ["Banbridge", "BNB"], ["Banffshire", "BAN"], ["Barking and Dagenham", "BDG"], ["Barnet", "BNE"], ["Barnsley", "BNS"], ["Bath and North East Somerset", "BAS"], ["Bedfordshire", "BDF"], ["Belfast", "BFS"], ["Berkshire", "BRK"], ["Berwickshire", "BEW"], ["Bexley", "BEX"], ["Birmingham", "BIR"], ["Blackburn with Darwen", "BBD"], ["Blackpool", "BPL"], ["Blaenau Gwent", "BGW"], ["Bolton", "BOL"], ["Borders", "BOR"], ["Bournemouth", "BMH"], ["Bracknell Forest", "BRC"], ["Bradford", "BRD"], ["Brent", "BEN"], ["Bridgend", "BGE"], ["Brighton and Hove", "BNH"], ["Bristol", "BST"], ["Bromley", "BRY"], ["Buckinghamshire", "BKM"], ["Bury", "BUR"], ["Caerphilly", "CAY"], ["Caithness", "CAI"], ["Calderdale", "CLD"], ["Cambridgeshire", "CAM"], ["Camden", "CMD"], ["Cardiff", "CRF"], ["Carmarthenshire", "CMN"], ["Carrickfergus", "CKF"], ["Castlereagh", "CSR"], ["Central Scotland", "CEN"], ["Ceredigion", "CGN"], ["Channel Islands", "CHI"], ["Cheshire", "CHS"], ["Clackmannanshire", "CLK"], ["Clwyd", "CWD"], ["Coleraine", "CLR"], ["Conwy", "CWY"], ["Cookstown", "CKT"], ["Cornwall", "CON"], ["County Antrim", "ANT"], ["County Armagh", "ARM"], ["County Down", "DOW"], ["County Durham", "DUR"], ["County Tyrone", "TYR"], ["Coventry (West Midlands district)", "COV"], ["Craigavon", "CGV"], ["Croydon", "CRY"], ["Cumbria", "CMA"], ["Darlington", "DAL"], ["Denbighshire", "DEN"], ["Derbyshire", "DBY"], ["Derbyshire", "DER"], ["Derry", "DRY"], ["Devon", "DEV"], ["Doncaster", "DNC"], ["Dorset", "DOR"], ["Dudley (West Midlands district)", "DUD"], ["Dumfries & Galloway", "DGY"], ["Dunbartonshire", "DNB"], ["Dundee", "DND"], ["Dungannon and South Tyrone", "DGN"], ["Dyfed", "DYD"], ["Ealing", "EAL"], ["East Ayrshire", "EAY"], ["East Dunbartonshire", "EDU"], ["East Lothian", "ELN"], ["East Renfrewshire", "ERW"], ["East Riding of Yorkshire", "ERY"], ["East Sussex", "ESX"], ["Edinburgh", "EDH"], ["Eilean Siar", "ELS"], ["Enfield", "ENF"], ["Essex", "ESS"], ["Falkirk", "FAL"], ["Fermanagh", "FER"], ["Fife", "FIF"], ["Flintshire", "FLN"], ["Gateshead (Tyne & Wear district)", "GAT"], ["Glamorgan", "GLA"], ["Glasgow", "GLG"], ["Gloucestershire", "GLS"], ["Grampian", "GMP"], ["Greenwich", "GRE"], ["Guernsey", "GSY"], ["Gwent", "GNT"], ["Gwynedd", "GWN"], ["Hackney", "HCK"], ["Halton", "HAL"], ["Hammersmith and Fulham", "HMF"], ["Hampshire", "HAM"], ["Haringey", "HRY"], ["Harrow", "HRW"], ["Hartlepool", "HPL"], ["Havering", "HAV"], ["Herefordshire", "HEF"], ["Hertfordshire", "HRT"], ["Highlands", "HLD"], ["Hillingdon", "HIL"], ["Hounslow", "HNS"], ["Inverclyde", "IVC"], ["Inverness-shire", "INV"], ["Isle of Man", "IOM"], ["Isle of Wight", "IOW"], ["Isles of Scilly", "IOS"], ["Islington", "ISL"], ["Jersey", "JSY"], ["Kensington and Chelsea", "KEC"], ["Kent", "KEN"], ["Kincardineshire", "KCD"], ["Kingston upon Hull City of", "KHL"], ["Kingston upon Thames", "KTT"], ["Kinross-shire", "KRS"], ["Kirkcudbrightshire", "KKD"], ["Kirklees", "KIR"], ["Knowsley", "KWL"], ["Lambeth", "LBH"], ["Lanarkshire", "LKS"], ["Lancashire", "LAN"], ["Larne", "LRN"], ["Leeds", "LDS"], ["Leicester", "LCE"], ["Leicestershire", "LEC"], ["Leicestershire", "LEI"], ["Lewisham", "LEW"], ["Limavady", "LMV"], ["Lincolnshire", "LIN"], ["Lisburn", "LSB"], ["Liverpool", "LIV"], ["London", "LND"], ["Londonderry", "LDY"], ["Luton", "LUT"], ["Magherafelt", "MFT"], ["Manchester", "MAN"], ["Manchester (Greater)", "GTM"], ["Medway", "MDW"], ["Merseyside", "MSY"], ["Merthyr Tydfil", "MTY"], ["Merton", "MRT"], ["Middlesbrough", "MDB"], ["Middlesex", "MDX"], ["Midlothian", "MLN"], ["Milton Keynes", "MIK"], ["Monmouthshire", "MON"], ["Moray", "MOR"], ["Moray", "MRY"], ["Moyle", "MYL"], ["Nairnshire", "NAI"], ["Neath Port Talbot", "NTL"], ["Newcastle upon Tyne", "NET"], ["Newham", "NWM"], ["Newport", "NWP"], ["Newry and Mourne", "NYM"], ["Newtownabbey", "NTA"], ["Norfolk", "NFK"], ["North Ayrshire", "NAY"], ["North Down", "NDN"], ["North East Lincolnshire", "NEL"], ["North Lanarkshire", "NLK"], ["North Lincolnshire", "NLN"], ["North Somerset", "NSM"], ["North Tyneside", "NTY"], ["North Yorkshire", "NYK"], ["Northamptonshire", "NTH"], ["Northumberland", "NBL"], ["Nottingham", "NGM"], ["Nottinghamshire", "NTT"], ["Oldham", "OLD"], ["Omagh", "OMH"], ["Orkney", "OKI"], ["Orkney Islands", "ORK"], ["Oxfordshire", "OXF"], ["Peeblesshire", "PEE"], ["Pembrokeshire", "PEM"], ["Perth and Kinross", "PKN"], ["Perthshire", "PER"], ["Peterborough", "PTE"], ["Plymouth", "PLY"], ["Poole", "POL"], ["Portsmouth", "POR"], ["Powys", "POW"], ["Reading", "RDG"], ["Redbridge", "RDB"], ["Redcar and Cleveland", "RCC"], ["Renfrewshire", "RFW"], ["Rhondda Cynon Taff", "RCT"], ["Richmond upon Thames", "RIC"], ["Rochdale", "RCH"], ["Ross and Cromarty", "ROC"], ["Rotherham", "ROT"], ["Roxburghshire", "ROX"], ["Rutland", "RUT"], ["Salford", "SLF"], ["Sandwell", "SAW"], ["Scottish Borders The", "SCB"], ["Sefton", "SFT"], ["Selkirkshire", "SEL"], ["Sheffield", "SHF"], ["Shetland", "SHI"], ["Shetland Islands", "ZET"], ["Shropshire", "SHR"], ["Slough", "SLG"], ["Solihull", "SOL"], ["Somerset", "SOM"], ["South Ayrshire", "SAY"], ["South Gloucestershire", "SGC"], ["South Lanarkshire", "SLK"], ["South Tyneside", "STY"], ["South Yorkshire", "SYK"], ["Southampton", "STH"], ["Southend-on-Sea", "SOS"], ["Southwark", "SWK"], ["St Helens", "SHN"], ["Staffordshire", "STS"], ["Stirling", "STG"], ["Stirlingshire", "STI"], ["Stockport", "SKP"], ["Stockton-on-Tees", "STT"], ["Stoke-on-Trent", "STE"], ["Strabane", "STB"], ["Strathclyde", "STD"], ["Suffolk", "SFK"], ["Sunderland", "SND"], ["Surrey", "SRY"], ["Sutherland", "SUT"], ["Sutton", "STN"], ["Swansea", "SWA"], ["Swindon", "SWD"], ["Tameside", "TAM"], ["Tayside", "TAY"], ["Telford and Wrekin", "TFW"], ["Thurrock", "THR"], ["Torbay", "TOB"], ["Torfaen", "TOF"], ["Tower Hamlets", "TWH"], ["Trafford", "TRF"], ["Tyne & Wear", "TWR"], ["Vale of Glamorgan", "VGL"], ["Wakefield", "WKF"], ["Walsall", "WLL"], ["Waltham Forest", "WFT"], ["Wandsworth", "WND"], ["Warrington", "WRT"], ["Warwickshire", "WAR"], ["West Berkshire", "WBK"], ["West Dunbartonshire", "WDU"], ["West Lothian", "WLN"], ["West Midlands", "WMD"], ["West Sussex", "SXW"], ["West Sussex", "WSX"], ["West Yorkshire", "WYK"], ["Western Isles", "WIS"], ["Westminster", "WSM"], ["Wigan", "WGN"], ["Wigtownshire", "WIG"], ["Wiltshire", "WIL"], ["Windsor and Maidenhead", "WNM"], ["Wirral", "WRL"], ["Wokingham", "WOK"], ["Wolverhampton", "WLV"], ["Worcestershire", "WOR"], ["Wrexham", "WRX"], ["York", "YOR"]]
    var options = '';
